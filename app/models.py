...
class View(db.Model):
    ...
    # unique_id can either be a `user.id` or `link.id`
    ...
    def __init__(self, unique_id, audience_id, state):
        self.unique_id   = unique_id
        self.audience_id = audience_id
        self.state = state

    def set_public_id(self):
        """Sets a Public ID for View"""

        self.public_id = get_public_id(f"{self.id}_view")
        self.save()

    def to_dict(self):
        """Returns Views's data as JSON/Dictionary"""
...
class Audience(db.Model):
    ...
    viewed    = db.relationship('View', order_by='View.id', backref='audience', lazy=True)

    def __init__(self, unique_id):
        self.unique_id = unique_id

    def set_public_id(self):
        """Sets a Public ID for Audience"""

        self.public_id = get_public_id(f"{self.id}_audience")
        self.save()

    def to_dict(self):
        """Returns Audience's data as JSON/Dictionary"""
